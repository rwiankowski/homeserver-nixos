...
in {
  ...
  systemd.tmpfiles.rules = [
    ...
    "d ${vars.storage.media}/audiobooks 0775 media media -"
    "d ${vars.storage.media}/podcasts 0775 media media -"
    ...
    "d ${vars.storage.docs}/paperless 0755 root root -"
    "d ${vars.storage.docs}/paperless/consume 0755 root root -"
    "d ${vars.storage.docs}/paperless/media 0755 root root -"
    "d ${vars.storage.docs}/paperless/export 0755 root root -"
    
    # Shared disk
    "d ${vars.storage.shared}/backups 0700 root root -"
    "d ${vars.storage.shared}/authentik 0755 root root -"
